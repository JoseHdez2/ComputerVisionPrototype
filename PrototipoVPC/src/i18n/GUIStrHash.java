...
public abstract class GUIStrHash { 
    ...
    static
    {
        ...
        hash.put(GUIStr.TRANSFORM_MENU_LINEAR_TRANSFORMATION, "TransformMenu.LinearTransformation");
        ...
        hash.put(GUIStr.TRIVIAL_R, "Trivial.R");
        hash.put(GUIStr.TRIVIAL_G, "Trivial.G");
        hash.put(GUIStr.TRIVIAL_B, "Trivial.B");
